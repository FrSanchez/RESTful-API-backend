 ...
 */
class DynamicContentVariationObjectNonIdEndpointTreeNode implements EndpointTreeNode
{
	...
	private function getIdEndpointTreeNode(): EndpointTreeNode
	{
		if (is_null($this->idEndpointTreeNode)) {
			$this->idEndpointTreeNode = new \Api\Config\Objects\DynamicContentVariation\Gen\Endpoint\DynamicContentVariationObjectIdEndpointTreeNode($this->objectDefinitionCatalog);
		}
	...
	private function getQueryEndpointDefinitionProvider(): ObjectQueryEndpointDefinitionProvider
	{
		if (is_null($this->queryEndpointDefinitionProvider)) {
			$this->queryEndpointDefinitionProvider = new \Api\Config\Objects\DynamicContentVariation\Gen\Endpoint\DynamicContentVariationQueryEndpointDefinitionProvider(
				$this->objectDefinitionCatalog,
				'DynamicContentVariation',
				'DynamicContentVariationQueryResultCollectionRepresentation',
				\Api\Gen\Representations\DynamicContentVariationQueryResultCollectionRepresentation::class,
false
			);
		}
