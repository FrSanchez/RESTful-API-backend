 ...
 */
class FolderObjectNonIdEndpointTreeNode implements EndpointTreeNode
{
	...
	private function getIdEndpointTreeNode(): EndpointTreeNode
	{
		if (is_null($this->idEndpointTreeNode)) {
			$this->idEndpointTreeNode = new \Api\Config\Objects\Folder\Gen\Endpoint\FolderObjectIdEndpointTreeNode($this->objectDefinitionCatalog);
		}
	...
	private function getQueryEndpointDefinitionProvider(): ObjectQueryEndpointDefinitionProvider
	{
		if (is_null($this->queryEndpointDefinitionProvider)) {
			$this->queryEndpointDefinitionProvider = new \Api\Config\Objects\Folder\Gen\Endpoint\FolderQueryEndpointDefinitionProvider(
				$this->objectDefinitionCatalog,
				'Folder',
				'FolderQueryResultCollectionRepresentation',
				\Api\Gen\Representations\FolderQueryResultCollectionRepresentation::class,
false
			);
		}
