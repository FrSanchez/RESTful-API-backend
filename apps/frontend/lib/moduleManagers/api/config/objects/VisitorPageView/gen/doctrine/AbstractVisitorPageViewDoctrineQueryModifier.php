<?php
namespace Api\Config\Objects\VisitorPageView\Gen\Doctrine;
 ...
 */
abstract class AbstractVisitorPageViewDoctrineQueryModifier extends \Api\Objects\Doctrine\DoctrineQueryModifier
{
	/**
