 ...
 */
class VisitorPageViewObjectNonIdEndpointTreeNode implements EndpointTreeNode
{
	...
	private function getIdEndpointTreeNode(): EndpointTreeNode
	{
		if (is_null($this->idEndpointTreeNode)) {
			$this->idEndpointTreeNode = new \Api\Config\Objects\VisitorPageView\Gen\Endpoint\VisitorPageViewObjectIdEndpointTreeNode($this->objectDefinitionCatalog);
		}
	...
	private function getQueryEndpointDefinitionProvider(): ObjectQueryEndpointDefinitionProvider
	{
		if (is_null($this->queryEndpointDefinitionProvider)) {
			$this->queryEndpointDefinitionProvider = new \Api\Config\Objects\VisitorPageView\Gen\Endpoint\VisitorPageViewQueryEndpointDefinitionProvider(
				$this->objectDefinitionCatalog,
				'VisitorPageView',
				'VisitorPageViewQueryResultCollectionRepresentation',
				\Api\Gen\Representations\VisitorPageViewQueryResultCollectionRepresentation::class,
false
			);
		}
