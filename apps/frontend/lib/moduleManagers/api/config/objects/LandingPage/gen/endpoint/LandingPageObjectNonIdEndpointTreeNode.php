 ...
 */
class LandingPageObjectNonIdEndpointTreeNode implements EndpointTreeNode
{
	...
	private function getIdEndpointTreeNode(): EndpointTreeNode
	{
		if (is_null($this->idEndpointTreeNode)) {
			$this->idEndpointTreeNode = new \Api\Config\Objects\LandingPage\Gen\Endpoint\LandingPageObjectIdEndpointTreeNode($this->objectDefinitionCatalog);
		}
	...
	private function getQueryEndpointDefinitionProvider(): ObjectQueryEndpointDefinitionProvider
	{
		if (is_null($this->queryEndpointDefinitionProvider)) {
			$this->queryEndpointDefinitionProvider = new \Api\Config\Objects\LandingPage\Gen\Endpoint\LandingPageQueryEndpointDefinitionProvider(
				$this->objectDefinitionCatalog,
				'LandingPage',
				'LandingPageQueryResultCollectionRepresentation',
				\Api\Gen\Representations\LandingPageQueryResultCollectionRepresentation::class,
true
			);
		}
