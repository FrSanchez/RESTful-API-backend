<?php
namespace Api\Config\Objects\LifecycleStageProspect\Gen\ExportProcedures;
 ...
 */
abstract class AbstractLifecycleStageProspectFilterByUpdatedAtProcedure implements \Api\Config\Objects\LifecycleStageProspect\Gen\ExportProcedures\LifecycleStageProspectFilterByUpdatedAtProcedureInterface
{
	/** @var int $accountId */
	 ...
	 * @throws Exception
	 */
	public function __construct(ProcedureDefinition $definition, int $version, int $accountId, array $arguments, bool $isInternalRequest, string $object = 'LifecycleStageProspect')
	{
	...
	/**
	 * Gets the object definition for LifecycleStageProspect.
