 ...
 */
class EmailTemplateObjectNonIdEndpointTreeNode implements EndpointTreeNode
{
	...
	private function getIdEndpointTreeNode(): EndpointTreeNode
	{
		if (is_null($this->idEndpointTreeNode)) {
			$this->idEndpointTreeNode = new \Api\Config\Objects\EmailTemplate\Gen\Endpoint\EmailTemplateObjectIdEndpointTreeNode($this->objectDefinitionCatalog);
		}
...
false				),
	...
	private function getQueryEndpointDefinitionProvider(): ObjectQueryEndpointDefinitionProvider
	{
		if (is_null($this->queryEndpointDefinitionProvider)) {
			$this->queryEndpointDefinitionProvider = new \Api\Config\Objects\EmailTemplate\Gen\Endpoint\EmailTemplateQueryEndpointDefinitionProvider(
				$this->objectDefinitionCatalog,
				'EmailTemplate',
				'EmailTemplateQueryResultCollectionRepresentation',
				\Api\Gen\Representations\EmailTemplateQueryResultCollectionRepresentation::class,
true
			);
		}
