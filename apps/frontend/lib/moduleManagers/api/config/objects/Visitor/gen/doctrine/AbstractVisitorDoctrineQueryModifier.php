<?php
namespace Api\Config\Objects\Visitor\Gen\Doctrine;
 ...
 */
abstract class AbstractVisitorDoctrineQueryModifier extends \Api\Objects\Doctrine\DoctrineQueryModifier
{
	/**
