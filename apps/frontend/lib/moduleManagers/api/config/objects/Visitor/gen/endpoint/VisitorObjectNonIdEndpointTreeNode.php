 ...
 */
class VisitorObjectNonIdEndpointTreeNode implements EndpointTreeNode
{
	...
	private function getIdEndpointTreeNode(): EndpointTreeNode
	{
		if (is_null($this->idEndpointTreeNode)) {
			$this->idEndpointTreeNode = new \Api\Config\Objects\Visitor\Gen\Endpoint\VisitorObjectIdEndpointTreeNode($this->objectDefinitionCatalog);
		}
	...
	private function getQueryEndpointDefinitionProvider(): ObjectQueryEndpointDefinitionProvider
	{
		if (is_null($this->queryEndpointDefinitionProvider)) {
			$this->queryEndpointDefinitionProvider = new \Api\Config\Objects\Visitor\Gen\Endpoint\VisitorQueryEndpointDefinitionProvider(
				$this->objectDefinitionCatalog,
				'Visitor',
				'VisitorQueryResultCollectionRepresentation',
				\Api\Gen\Representations\VisitorQueryResultCollectionRepresentation::class,
true
			);
		}
