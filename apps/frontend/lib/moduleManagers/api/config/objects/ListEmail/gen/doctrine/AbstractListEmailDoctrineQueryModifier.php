<?php
namespace Api\Config\Objects\ListEmail\Gen\Doctrine;
 ...
 */
abstract class AbstractListEmailDoctrineQueryModifier extends \Api\Objects\Doctrine\DoctrineQueryModifier
{
	/**
