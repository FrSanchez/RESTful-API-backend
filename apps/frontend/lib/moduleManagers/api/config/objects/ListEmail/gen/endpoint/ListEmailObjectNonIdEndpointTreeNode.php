<?php
namespace Api\Config\Objects\ListEmail\Gen\Endpoint;
 ...
 */
class ListEmailObjectNonIdEndpointTreeNode implements EndpointTreeNode
{
	...
	private function getIdEndpointTreeNode(): EndpointTreeNode
	{
		if (is_null($this->idEndpointTreeNode)) {
			$this->idEndpointTreeNode = new \Api\Config\Objects\ListEmail\Gen\Endpoint\ListEmailObjectIdEndpointTreeNode($this->objectDefinitionCatalog);
		}
	...
	private function getQueryEndpointDefinitionProvider(): ObjectQueryEndpointDefinitionProvider
	{
		if (is_null($this->queryEndpointDefinitionProvider)) {
			$this->queryEndpointDefinitionProvider = new \Api\Config\Objects\ListEmail\Gen\Endpoint\ListEmailQueryEndpointDefinitionProvider(
				$this->objectDefinitionCatalog,
				'ListEmail',
				'ListEmailQueryResultCollectionRepresentation',
				\Api\Gen\Representations\ListEmailQueryResultCollectionRepresentation::class,
true
			);
		}
