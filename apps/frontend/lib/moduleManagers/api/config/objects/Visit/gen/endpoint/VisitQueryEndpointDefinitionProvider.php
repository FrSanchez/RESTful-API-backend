 ...
 */
class VisitQueryEndpointDefinitionProvider extends ObjectQueryEndpointDefinitionProvider
{
	protected function getAdditionalEndpointParameters(): array
	{
		...
		$additionalParameters[] = new EndpointParameterDefinition('prospectIdIsNull', \Api\DataTypes\BooleanDataType::getInstance());
		$additionalParameters[] = new EndpointParameterDefinition('prospectIdIsNotNull', \Api\DataTypes\BooleanDataType::getInstance());
