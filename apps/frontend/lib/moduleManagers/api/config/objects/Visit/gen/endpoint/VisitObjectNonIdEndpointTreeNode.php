<?php
namespace Api\Config\Objects\Visit\Gen\Endpoint;
 ...
 */
class VisitObjectNonIdEndpointTreeNode implements EndpointTreeNode
{
	...
	private function getIdEndpointTreeNode(): EndpointTreeNode
	{
		if (is_null($this->idEndpointTreeNode)) {
			$this->idEndpointTreeNode = new \Api\Config\Objects\Visit\Gen\Endpoint\VisitObjectIdEndpointTreeNode($this->objectDefinitionCatalog);
		}
	...
	private function getQueryEndpointDefinitionProvider(): ObjectQueryEndpointDefinitionProvider
	{
		if (is_null($this->queryEndpointDefinitionProvider)) {
			$this->queryEndpointDefinitionProvider = new \Api\Config\Objects\Visit\Gen\Endpoint\VisitQueryEndpointDefinitionProvider(
				$this->objectDefinitionCatalog,
				'Visit',
				'VisitQueryResultCollectionRepresentation',
				\Api\Gen\Representations\VisitQueryResultCollectionRepresentation::class,
false
			);
		}
