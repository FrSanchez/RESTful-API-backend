 ...
 */
class OpportunityObjectNonIdEndpointTreeNode implements EndpointTreeNode
{
	...
	private function getIdEndpointTreeNode(): EndpointTreeNode
	{
		if (is_null($this->idEndpointTreeNode)) {
			$this->idEndpointTreeNode = new \Api\Config\Objects\Opportunity\Gen\Endpoint\OpportunityObjectIdEndpointTreeNode($this->objectDefinitionCatalog);
		}
	...
	private function getQueryEndpointDefinitionProvider(): ObjectQueryEndpointDefinitionProvider
	{
		if (is_null($this->queryEndpointDefinitionProvider)) {
			$this->queryEndpointDefinitionProvider = new \Api\Config\Objects\Opportunity\Gen\Endpoint\OpportunityQueryEndpointDefinitionProvider(
				$this->objectDefinitionCatalog,
				'Opportunity',
				'OpportunityQueryResultCollectionRepresentation',
				\Api\Gen\Representations\OpportunityQueryResultCollectionRepresentation::class,
false
			);
		}
