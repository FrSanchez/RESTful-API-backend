<?php
namespace Api\Config\Objects\ListMembership\Gen\Doctrine;
 ...
 */
abstract class AbstractListMembershipDoctrineQueryModifier extends \Api\Objects\Doctrine\DoctrineQueryModifier
{
	/**
