 ...
 */
class ListMembershipObjectNonIdEndpointTreeNode implements EndpointTreeNode
{
	...
	private function getIdEndpointTreeNode(): EndpointTreeNode
	{
		if (is_null($this->idEndpointTreeNode)) {
			$this->idEndpointTreeNode = new \Api\Config\Objects\ListMembership\Gen\Endpoint\ListMembershipObjectIdEndpointTreeNode($this->objectDefinitionCatalog);
		}
		...
		if (is_null($this->createEndpointDefinitionProvider)) {
			$this->createEndpointDefinitionProvider = new ObjectCreateEndpointDefinitionProvider(
				...
				EndpointInputDefinition::createInputDefinitionWithRepresentationAndBinary(
					'ListMembershipRepresentation',
					\Api\Gen\Representations\ListMembershipRepresentation::class,
false				),
				'ListMembershipRepresentation',
				\Api\Gen\Representations\ListMembershipRepresentation::class
			);
	...
	private function getQueryEndpointDefinitionProvider(): ObjectQueryEndpointDefinitionProvider
	{
		if (is_null($this->queryEndpointDefinitionProvider)) {
			$this->queryEndpointDefinitionProvider = new \Api\Config\Objects\ListMembership\Gen\Endpoint\ListMembershipQueryEndpointDefinitionProvider(
				$this->objectDefinitionCatalog,
				'ListMembership',
				'ListMembershipQueryResultCollectionRepresentation',
				\Api\Gen\Representations\ListMembershipQueryResultCollectionRepresentation::class,
true
			);
		}
