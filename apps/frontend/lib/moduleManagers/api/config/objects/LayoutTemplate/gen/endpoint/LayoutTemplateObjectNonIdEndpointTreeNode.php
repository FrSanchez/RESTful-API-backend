<?php
namespace Api\Config\Objects\LayoutTemplate\Gen\Endpoint;
 ...
 */
class LayoutTemplateObjectNonIdEndpointTreeNode implements EndpointTreeNode
{
	...
	private function getIdEndpointTreeNode(): EndpointTreeNode
	{
		if (is_null($this->idEndpointTreeNode)) {
			$this->idEndpointTreeNode = new \Api\Config\Objects\LayoutTemplate\Gen\Endpoint\LayoutTemplateObjectIdEndpointTreeNode($this->objectDefinitionCatalog);
		}
		...
		if (is_null($this->createEndpointDefinitionProvider)) {
			$this->createEndpointDefinitionProvider = new ObjectCreateEndpointDefinitionProvider(
				...
				EndpointInputDefinition::createInputDefinitionWithRepresentationAndBinary(
					'LayoutTemplateRepresentation',
					\Api\Gen\Representations\LayoutTemplateRepresentation::class,
false				),
				'LayoutTemplateRepresentation',
				\Api\Gen\Representations\LayoutTemplateRepresentation::class
			);
	...
	private function getQueryEndpointDefinitionProvider(): ObjectQueryEndpointDefinitionProvider
	{
		if (is_null($this->queryEndpointDefinitionProvider)) {
			$this->queryEndpointDefinitionProvider = new \Api\Config\Objects\LayoutTemplate\Gen\Endpoint\LayoutTemplateQueryEndpointDefinitionProvider(
				$this->objectDefinitionCatalog,
				'LayoutTemplate',
				'LayoutTemplateQueryResultCollectionRepresentation',
				\Api\Gen\Representations\LayoutTemplateQueryResultCollectionRepresentation::class,
true
			);
		}
