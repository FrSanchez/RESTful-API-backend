<?php
namespace Api\Config\Objects\Email\Gen\ExportProcedures;
 ...
 */
abstract class AbstractEmailFilterByUpdatedAtProcedure implements \Api\Config\Objects\Email\Gen\ExportProcedures\EmailFilterByUpdatedAtProcedureInterface
{
	/** @var int $accountId */
	 ...
	 * @throws Exception
	 */
	public function __construct(ProcedureDefinition $definition, int $version, int $accountId, array $arguments, bool $isInternalRequest, string $object = 'Email')
	{
	...
	/**
	 * Gets the object definition for Email.
