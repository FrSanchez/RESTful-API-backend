 ...
 */
class EmailObjectNonIdEndpointTreeNode implements EndpointTreeNode
{
	...
	private function getIdEndpointTreeNode(): EndpointTreeNode
	{
		if (is_null($this->idEndpointTreeNode)) {
			$this->idEndpointTreeNode = new \Api\Config\Objects\Email\Gen\Endpoint\EmailObjectIdEndpointTreeNode($this->objectDefinitionCatalog);
		}
	...
	private function getQueryEndpointDefinitionProvider(): ObjectQueryEndpointDefinitionProvider
	{
		if (is_null($this->queryEndpointDefinitionProvider)) {
			$this->queryEndpointDefinitionProvider = new \Api\Config\Objects\Email\Gen\Endpoint\EmailQueryEndpointDefinitionProvider(
				$this->objectDefinitionCatalog,
				'Email',
				'EmailQueryResultCollectionRepresentation',
				\Api\Gen\Representations\EmailQueryResultCollectionRepresentation::class,
false
			);
		}
