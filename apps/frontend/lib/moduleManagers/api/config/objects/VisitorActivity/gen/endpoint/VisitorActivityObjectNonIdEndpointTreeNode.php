 ...
 */
class VisitorActivityObjectNonIdEndpointTreeNode implements EndpointTreeNode
{
	...
	private function getIdEndpointTreeNode(): EndpointTreeNode
	{
		if (is_null($this->idEndpointTreeNode)) {
			$this->idEndpointTreeNode = new \Api\Config\Objects\VisitorActivity\Gen\Endpoint\VisitorActivityObjectIdEndpointTreeNode($this->objectDefinitionCatalog);
		}
	...
	private function getQueryEndpointDefinitionProvider(): ObjectQueryEndpointDefinitionProvider
	{
		if (is_null($this->queryEndpointDefinitionProvider)) {
			$this->queryEndpointDefinitionProvider = new \Api\Config\Objects\VisitorActivity\Gen\Endpoint\VisitorActivityQueryEndpointDefinitionProvider(
				$this->objectDefinitionCatalog,
				'VisitorActivity',
				'VisitorActivityQueryResultCollectionRepresentation',
				\Api\Gen\Representations\VisitorActivityQueryResultCollectionRepresentation::class,
false
			);
		}
