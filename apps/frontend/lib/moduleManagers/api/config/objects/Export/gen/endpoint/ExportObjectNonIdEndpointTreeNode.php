<?php
namespace Api\Config\Objects\Export\Gen\Endpoint;
 ...
 */
class ExportObjectNonIdEndpointTreeNode implements EndpointTreeNode
{
	...
	private function getIdEndpointTreeNode(): EndpointTreeNode
	{
		if (is_null($this->idEndpointTreeNode)) {
			$this->idEndpointTreeNode = new \Api\Config\Objects\Export\Gen\Endpoint\ExportObjectIdEndpointTreeNode($this->objectDefinitionCatalog);
		}
		...
		if (is_null($this->createEndpointDefinitionProvider)) {
			$this->createEndpointDefinitionProvider = new ObjectCreateEndpointDefinitionProvider(
				...
				EndpointInputDefinition::createInputDefinitionWithRepresentationAndBinary(
					...
					\Api\Gen\Representations\ExportRepresentation::class,
false				),
				'ExportRepresentation',
				\Api\Gen\Representations\ExportRepresentation::class
			);
	...
	private function getQueryEndpointDefinitionProvider(): ObjectQueryEndpointDefinitionProvider
	{
		if (is_null($this->queryEndpointDefinitionProvider)) {
			$this->queryEndpointDefinitionProvider = new \Api\Config\Objects\Export\Gen\Endpoint\ExportQueryEndpointDefinitionProvider(
				$this->objectDefinitionCatalog,
				'Export',
				'ExportQueryResultCollectionRepresentation',
				\Api\Gen\Representations\ExportQueryResultCollectionRepresentation::class,
false
			);
		}
