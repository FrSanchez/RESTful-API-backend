 ...
 */
class ImportQueryEndpointDefinitionProvider extends ObjectQueryEndpointDefinitionProvider
{
	protected function getAdditionalEndpointParameters(): array
	{
		...
		$additionalParameters[] = new EndpointParameterDefinition('isExpired', \Api\DataTypes\BooleanDataType::getInstance());
