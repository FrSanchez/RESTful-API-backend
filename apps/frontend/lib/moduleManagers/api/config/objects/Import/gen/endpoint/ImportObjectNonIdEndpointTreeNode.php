 ...
 */
class ImportObjectNonIdEndpointTreeNode implements EndpointTreeNode
{
	...
	private function getIdEndpointTreeNode(): EndpointTreeNode
	{
		if (is_null($this->idEndpointTreeNode)) {
			$this->idEndpointTreeNode = new \Api\Config\Objects\Import\Gen\Endpoint\ImportObjectIdEndpointTreeNode($this->objectDefinitionCatalog);
		}
...
false				),
	...
	private function getQueryEndpointDefinitionProvider(): ObjectQueryEndpointDefinitionProvider
	{
		if (is_null($this->queryEndpointDefinitionProvider)) {
			$this->queryEndpointDefinitionProvider = new \Api\Config\Objects\Import\Gen\Endpoint\ImportQueryEndpointDefinitionProvider(
				$this->objectDefinitionCatalog,
				'Import',
				'ImportQueryResultCollectionRepresentation',
				\Api\Gen\Representations\ImportQueryResultCollectionRepresentation::class,
false
			);
		}
