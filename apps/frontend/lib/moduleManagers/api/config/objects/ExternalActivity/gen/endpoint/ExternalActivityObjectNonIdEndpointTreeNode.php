 ...
 */
class ExternalActivityObjectNonIdEndpointTreeNode implements EndpointTreeNode
{
	...
	private function getIdEndpointTreeNode(): EndpointTreeNode
	{
		if (is_null($this->idEndpointTreeNode)) {
			$this->idEndpointTreeNode = new \Api\Config\Objects\ExternalActivity\Gen\Endpoint\ExternalActivityObjectIdEndpointTreeNode($this->objectDefinitionCatalog);
		}
	...
	private function getQueryEndpointDefinitionProvider(): ObjectQueryEndpointDefinitionProvider
	{
		if (is_null($this->queryEndpointDefinitionProvider)) {
			$this->queryEndpointDefinitionProvider = new \Api\Config\Objects\ExternalActivity\Gen\Endpoint\ExternalActivityQueryEndpointDefinitionProvider(
				$this->objectDefinitionCatalog,
				'ExternalActivity',
				'ExternalActivityQueryResultCollectionRepresentation',
				\Api\Gen\Representations\ExternalActivityQueryResultCollectionRepresentation::class,
false
			);
		}
