<?php
namespace Api\Config\Objects\LifecycleStage\Gen\Doctrine;
 ...
 */
abstract class AbstractLifecycleStageDoctrineQueryModifier extends \Api\Objects\Doctrine\DoctrineQueryModifier
{
	/**
