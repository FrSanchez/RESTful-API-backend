 ...
 */
class CustomRedirectObjectNonIdEndpointTreeNode implements EndpointTreeNode
{
	...
	private function getIdEndpointTreeNode(): EndpointTreeNode
	{
		if (is_null($this->idEndpointTreeNode)) {
			$this->idEndpointTreeNode = new \Api\Config\Objects\CustomRedirect\Gen\Endpoint\CustomRedirectObjectIdEndpointTreeNode($this->objectDefinitionCatalog);
		}
...
false				),
	...
	private function getQueryEndpointDefinitionProvider(): ObjectQueryEndpointDefinitionProvider
	{
		if (is_null($this->queryEndpointDefinitionProvider)) {
			$this->queryEndpointDefinitionProvider = new \Api\Config\Objects\CustomRedirect\Gen\Endpoint\CustomRedirectQueryEndpointDefinitionProvider(
				$this->objectDefinitionCatalog,
				'CustomRedirect',
				'CustomRedirectQueryResultCollectionRepresentation',
				\Api\Gen\Representations\CustomRedirectQueryResultCollectionRepresentation::class,
true
			);
		}
