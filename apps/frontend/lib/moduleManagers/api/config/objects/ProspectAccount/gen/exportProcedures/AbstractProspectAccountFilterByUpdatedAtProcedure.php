 ...
 */
abstract class AbstractProspectAccountFilterByUpdatedAtProcedure implements \Api\Config\Objects\ProspectAccount\Gen\ExportProcedures\ProspectAccountFilterByUpdatedAtProcedureInterface
{
	/** @var int $accountId */
	 ...
	 * @throws Exception
	 */
	public function __construct(ProcedureDefinition $definition, int $version, int $accountId, array $arguments, bool $isInternalRequest, string $object = 'ProspectAccount')
	{
	...
	/**
	 * Gets the object definition for ProspectAccount.
