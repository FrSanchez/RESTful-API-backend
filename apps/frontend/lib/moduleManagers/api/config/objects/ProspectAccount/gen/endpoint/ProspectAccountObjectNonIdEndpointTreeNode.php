<?php
namespace Api\Config\Objects\ProspectAccount\Gen\Endpoint;
 ...
 */
class ProspectAccountObjectNonIdEndpointTreeNode implements EndpointTreeNode
{
	...
	private function getIdEndpointTreeNode(): EndpointTreeNode
	{
		if (is_null($this->idEndpointTreeNode)) {
			$this->idEndpointTreeNode = new \Api\Config\Objects\ProspectAccount\Gen\Endpoint\ProspectAccountObjectIdEndpointTreeNode($this->objectDefinitionCatalog);
		}
	...
	private function getQueryEndpointDefinitionProvider(): ObjectQueryEndpointDefinitionProvider
	{
		if (is_null($this->queryEndpointDefinitionProvider)) {
			$this->queryEndpointDefinitionProvider = new \Api\Config\Objects\ProspectAccount\Gen\Endpoint\ProspectAccountQueryEndpointDefinitionProvider(
				$this->objectDefinitionCatalog,
				'ProspectAccount',
				'ProspectAccountQueryResultCollectionRepresentation',
				\Api\Gen\Representations\ProspectAccountQueryResultCollectionRepresentation::class,
true
			);
		}
