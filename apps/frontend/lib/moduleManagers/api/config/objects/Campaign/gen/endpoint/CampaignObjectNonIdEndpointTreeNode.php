<?php
namespace Api\Config\Objects\Campaign\Gen\Endpoint;
 ...
 */
class CampaignObjectNonIdEndpointTreeNode implements EndpointTreeNode
{
	...
	private function getIdEndpointTreeNode(): EndpointTreeNode
	{
		if (is_null($this->idEndpointTreeNode)) {
			$this->idEndpointTreeNode = new \Api\Config\Objects\Campaign\Gen\Endpoint\CampaignObjectIdEndpointTreeNode($this->objectDefinitionCatalog);
		}
	...
	private function getQueryEndpointDefinitionProvider(): ObjectQueryEndpointDefinitionProvider
	{
		if (is_null($this->queryEndpointDefinitionProvider)) {
			$this->queryEndpointDefinitionProvider = new \Api\Config\Objects\Campaign\Gen\Endpoint\CampaignQueryEndpointDefinitionProvider(
				$this->objectDefinitionCatalog,
				'Campaign',
				'CampaignQueryResultCollectionRepresentation',
				\Api\Gen\Representations\CampaignQueryResultCollectionRepresentation::class,
true
			);
		}
