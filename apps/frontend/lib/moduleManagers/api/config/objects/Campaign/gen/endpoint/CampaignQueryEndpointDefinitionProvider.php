 ...
 */
class CampaignQueryEndpointDefinitionProvider extends ObjectQueryEndpointDefinitionProvider
{
	protected function getAdditionalEndpointParameters(): array
	{
		...
		$additionalParameters[] = new EndpointParameterDefinition('name', \Api\DataTypes\StringDataType::getInstance());
