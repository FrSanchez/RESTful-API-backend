<?php
namespace Api\Config\Objects\Listx\Gen\Endpoint;
 ...
 */
class ListObjectNonIdEndpointTreeNode implements EndpointTreeNode
{
	...
	private function getIdEndpointTreeNode(): EndpointTreeNode
	{
		if (is_null($this->idEndpointTreeNode)) {
			$this->idEndpointTreeNode = new \Api\Config\Objects\Listx\Gen\Endpoint\ListObjectIdEndpointTreeNode($this->objectDefinitionCatalog);
		}
		...
		if (is_null($this->createEndpointDefinitionProvider)) {
			$this->createEndpointDefinitionProvider = new ObjectCreateEndpointDefinitionProvider(
				...
				EndpointInputDefinition::createInputDefinitionWithRepresentationAndBinary(
					'ListRepresentation',
					\Api\Gen\Representations\ListRepresentation::class,
false				),
				'ListRepresentation',
				\Api\Gen\Representations\ListRepresentation::class
			);
	...
	private function getQueryEndpointDefinitionProvider(): ObjectQueryEndpointDefinitionProvider
	{
		if (is_null($this->queryEndpointDefinitionProvider)) {
			$this->queryEndpointDefinitionProvider = new \Api\Config\Objects\Listx\Gen\Endpoint\ListQueryEndpointDefinitionProvider(
				$this->objectDefinitionCatalog,
				'List',
				'ListQueryResultCollectionRepresentation',
				\Api\Gen\Representations\ListQueryResultCollectionRepresentation::class,
true
			);
		}
