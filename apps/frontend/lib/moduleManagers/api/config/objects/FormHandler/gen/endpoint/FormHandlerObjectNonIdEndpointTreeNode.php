 ...
 */
class FormHandlerObjectNonIdEndpointTreeNode implements EndpointTreeNode
{
	...
	private function getIdEndpointTreeNode(): EndpointTreeNode
	{
		if (is_null($this->idEndpointTreeNode)) {
			$this->idEndpointTreeNode = new \Api\Config\Objects\FormHandler\Gen\Endpoint\FormHandlerObjectIdEndpointTreeNode($this->objectDefinitionCatalog);
		}
...
false				),
	...
	private function getQueryEndpointDefinitionProvider(): ObjectQueryEndpointDefinitionProvider
	{
		if (is_null($this->queryEndpointDefinitionProvider)) {
			$this->queryEndpointDefinitionProvider = new \Api\Config\Objects\FormHandler\Gen\Endpoint\FormHandlerQueryEndpointDefinitionProvider(
				$this->objectDefinitionCatalog,
				'FormHandler',
				'FormHandlerQueryResultCollectionRepresentation',
				\Api\Gen\Representations\FormHandlerQueryResultCollectionRepresentation::class,
true
			);
		}
