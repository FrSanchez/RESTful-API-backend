<?php
namespace Api\Config\Objects\LifecycleHistory\Gen\Doctrine;
 ...
 */
abstract class AbstractLifecycleHistoryDoctrineQueryModifier extends \Api\Objects\Doctrine\DoctrineQueryModifier
{
	/**
