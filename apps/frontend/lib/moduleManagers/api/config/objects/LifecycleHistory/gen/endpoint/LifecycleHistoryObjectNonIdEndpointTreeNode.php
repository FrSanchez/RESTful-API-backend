<?php
namespace Api\Config\Objects\LifecycleHistory\Gen\Endpoint;
 ...
 */
class LifecycleHistoryObjectNonIdEndpointTreeNode implements EndpointTreeNode
{
	...
	private function getIdEndpointTreeNode(): EndpointTreeNode
	{
		if (is_null($this->idEndpointTreeNode)) {
			$this->idEndpointTreeNode = new \Api\Config\Objects\LifecycleHistory\Gen\Endpoint\LifecycleHistoryObjectIdEndpointTreeNode($this->objectDefinitionCatalog);
		}
	...
	private function getQueryEndpointDefinitionProvider(): ObjectQueryEndpointDefinitionProvider
	{
		if (is_null($this->queryEndpointDefinitionProvider)) {
			$this->queryEndpointDefinitionProvider = new \Api\Config\Objects\LifecycleHistory\Gen\Endpoint\LifecycleHistoryQueryEndpointDefinitionProvider(
				$this->objectDefinitionCatalog,
				'LifecycleHistory',
				'LifecycleHistoryQueryResultCollectionRepresentation',
				\Api\Gen\Representations\LifecycleHistoryQueryResultCollectionRepresentation::class,
false
			);
		}
