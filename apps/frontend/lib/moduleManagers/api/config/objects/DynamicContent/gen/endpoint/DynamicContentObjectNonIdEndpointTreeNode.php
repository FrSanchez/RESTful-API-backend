<?php
namespace Api\Config\Objects\DynamicContent\Gen\Endpoint;
 ...
 */
class DynamicContentObjectNonIdEndpointTreeNode implements EndpointTreeNode
{
	...
	private function getIdEndpointTreeNode(): EndpointTreeNode
	{
		if (is_null($this->idEndpointTreeNode)) {
			$this->idEndpointTreeNode = new \Api\Config\Objects\DynamicContent\Gen\Endpoint\DynamicContentObjectIdEndpointTreeNode($this->objectDefinitionCatalog);
		}
	...
	private function getQueryEndpointDefinitionProvider(): ObjectQueryEndpointDefinitionProvider
	{
		if (is_null($this->queryEndpointDefinitionProvider)) {
			$this->queryEndpointDefinitionProvider = new \Api\Config\Objects\DynamicContent\Gen\Endpoint\DynamicContentQueryEndpointDefinitionProvider(
				$this->objectDefinitionCatalog,
				'DynamicContent',
				'DynamicContentQueryResultCollectionRepresentation',
				\Api\Gen\Representations\DynamicContentQueryResultCollectionRepresentation::class,
true
			);
		}
