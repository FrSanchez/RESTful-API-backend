 ...
 */
class UserObjectNonIdEndpointTreeNode implements EndpointTreeNode
{
	...
	private function getIdEndpointTreeNode(): EndpointTreeNode
	{
		if (is_null($this->idEndpointTreeNode)) {
			$this->idEndpointTreeNode = new \Api\Config\Objects\User\Gen\Endpoint\UserObjectIdEndpointTreeNode($this->objectDefinitionCatalog);
		}
	...
	private function getQueryEndpointDefinitionProvider(): ObjectQueryEndpointDefinitionProvider
	{
		if (is_null($this->queryEndpointDefinitionProvider)) {
			$this->queryEndpointDefinitionProvider = new \Api\Config\Objects\User\Gen\Endpoint\UserQueryEndpointDefinitionProvider(
				$this->objectDefinitionCatalog,
				'User',
				'UserQueryResultCollectionRepresentation',
				\Api\Gen\Representations\UserQueryResultCollectionRepresentation::class,
true
			);
		}
