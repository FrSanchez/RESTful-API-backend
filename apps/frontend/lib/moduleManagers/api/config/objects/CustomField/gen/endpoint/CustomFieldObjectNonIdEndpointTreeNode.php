<?php
namespace Api\Config\Objects\CustomField\Gen\Endpoint;
 ...
 */
class CustomFieldObjectNonIdEndpointTreeNode implements EndpointTreeNode
{
	...
	private function getIdEndpointTreeNode(): EndpointTreeNode
	{
		if (is_null($this->idEndpointTreeNode)) {
			$this->idEndpointTreeNode = new \Api\Config\Objects\CustomField\Gen\Endpoint\CustomFieldObjectIdEndpointTreeNode($this->objectDefinitionCatalog);
		}
		...
		if (is_null($this->createEndpointDefinitionProvider)) {
			$this->createEndpointDefinitionProvider = new ObjectCreateEndpointDefinitionProvider(
				...
				EndpointInputDefinition::createInputDefinitionWithRepresentationAndBinary(
					...
					\Api\Gen\Representations\CustomFieldRepresentation::class,
false				),
				'CustomFieldRepresentation',
				\Api\Gen\Representations\CustomFieldRepresentation::class
			);
	...
	private function getQueryEndpointDefinitionProvider(): ObjectQueryEndpointDefinitionProvider
	{
		if (is_null($this->queryEndpointDefinitionProvider)) {
			$this->queryEndpointDefinitionProvider = new \Api\Config\Objects\CustomField\Gen\Endpoint\CustomFieldQueryEndpointDefinitionProvider(
				$this->objectDefinitionCatalog,
				'CustomField',
				'CustomFieldQueryResultCollectionRepresentation',
				\Api\Gen\Representations\CustomFieldQueryResultCollectionRepresentation::class,
false
			);
		}
