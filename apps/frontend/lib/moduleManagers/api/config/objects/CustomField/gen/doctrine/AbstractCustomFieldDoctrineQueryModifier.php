<?php
namespace Api\Config\Objects\CustomField\Gen\Doctrine;
 ...
 */
abstract class AbstractCustomFieldDoctrineQueryModifier extends \Api\Objects\Doctrine\DoctrineQueryModifier
{
	/**
	...
	public function modifyQueryBuilderWithDerivedFields(QueryBuilderNode $queryBuilderNode, array $derivedFieldDefinitions): void
	{
		foreach ($derivedFieldDefinitions as $fieldDef) {
			switch ($fieldDef->getName()) {
				case 'apiFieldId':
				case 'api_field_id':
					$this->modifyQueryWithApiFieldIdField($queryBuilderNode, $fieldDef);
					break;
				default:
	...
	protected function getValueForDerivedField(\Doctrine_Record $doctrineRecord, FieldDefinition $fieldDef)
	{
		switch ($fieldDef->getName()) {
			case 'apiFieldId':
			case 'api_field_id':
				return $this->getValueForApiFieldIdField($doctrineRecord, $fieldDef);
			default:
	...
	/**
	 * Override this method to add any additional fields or joins to calculate the apiFieldId field. You should also override
	 * the getValueForApiFieldIdField function to handle calculating the apiFieldId value.
	 *
	 * @param QueryBuilderNode $queryBuilderRoot
	 * @param FieldDefinition $fieldDef
	 * @see getValueForApiFieldIdField
	 */
	protected abstract function modifyQueryWithApiFieldIdField(QueryBuilderNode $queryBuilderRoot, FieldDefinition $fieldDef);

	/**
	 * @param \Doctrine_Record $doctrineRecord
	 * @param FieldDefinition $fieldDef
	 * @return mixed
	 * @see modifyQueryWithApiFieldIdField
	 */
	protected abstract function getValueForApiFieldIdField(\Doctrine_Record $doctrineRecord, FieldDefinition $fieldDef);
