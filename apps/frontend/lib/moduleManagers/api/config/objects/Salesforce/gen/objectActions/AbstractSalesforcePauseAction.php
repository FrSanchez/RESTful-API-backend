 ...
 */
abstract class AbstractSalesforcePauseAction implements ObjectAction
{
	/**
	...
	final public function executeObjectAction(
		...
		if (!$bodyRepresentation instanceof \Api\Gen\Representations\SalesforcePauseObjectActionInputRepresentation) {
			throw new RuntimeException("Unexpected type for body representation. Expected \Api\Gen\Representations\SalesforcePauseObjectActionInputRepresentation.");
		}
	...
	/**
	 * @param \Api\Gen\Representations\SalesforcePauseObjectActionInputRepresentation $representation
	 */
	private function validateRequiredProperties(\Api\Gen\Representations\SalesforcePauseObjectActionInputRepresentation $representation): void
	{
		$invalidProperties = [];
	 ...
	 * @param \Api\Gen\Representations\SalesforcePauseObjectActionInputRepresentation $representation
	 */
	private function validateNonNullableProperties(\Api\Gen\Representations\SalesforcePauseObjectActionInputRepresentation $representation): void
	{
		$invalidProperties = [];
