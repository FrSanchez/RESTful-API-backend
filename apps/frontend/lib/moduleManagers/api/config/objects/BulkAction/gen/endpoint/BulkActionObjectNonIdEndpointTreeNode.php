 ...
 */
class BulkActionObjectNonIdEndpointTreeNode implements EndpointTreeNode
{
	...
	private function getIdEndpointTreeNode(): EndpointTreeNode
	{
		if (is_null($this->idEndpointTreeNode)) {
			$this->idEndpointTreeNode = new \Api\Config\Objects\BulkAction\Gen\Endpoint\BulkActionObjectIdEndpointTreeNode($this->objectDefinitionCatalog);
		}
...
false				),
	...
	private function getQueryEndpointDefinitionProvider(): ObjectQueryEndpointDefinitionProvider
	{
		if (is_null($this->queryEndpointDefinitionProvider)) {
			$this->queryEndpointDefinitionProvider = new \Api\Config\Objects\BulkAction\Gen\Endpoint\BulkActionQueryEndpointDefinitionProvider(
				$this->objectDefinitionCatalog,
				'BulkAction',
				'BulkActionQueryResultCollectionRepresentation',
				\Api\Gen\Representations\BulkActionQueryResultCollectionRepresentation::class,
false
			);
		}
