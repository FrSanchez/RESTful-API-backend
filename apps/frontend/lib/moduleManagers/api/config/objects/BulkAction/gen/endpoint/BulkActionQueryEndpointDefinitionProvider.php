 ...
 */
class BulkActionQueryEndpointDefinitionProvider extends ObjectQueryEndpointDefinitionProvider
{
	protected function getAdditionalEndpointParameters(): array
	{
		...
		$additionalParameters[] = new EndpointParameterDefinition('object', \Api\DataTypes\StringDataType::getInstance());
		$additionalParameters[] = new EndpointParameterDefinition('bulkAction', \Api\DataTypes\StringDataType::getInstance());
		$additionalParameters[] = new EndpointParameterDefinition('status', \Api\DataTypes\StringDataType::getInstance());
		$additionalParameters[] = new EndpointParameterDefinition('origin', \Api\DataTypes\StringDataType::getInstance());
