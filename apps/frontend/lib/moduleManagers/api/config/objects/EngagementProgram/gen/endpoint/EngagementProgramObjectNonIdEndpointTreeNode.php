<?php
namespace Api\Config\Objects\EngagementProgram\Gen\Endpoint;
 ...
 */
class EngagementProgramObjectNonIdEndpointTreeNode implements EndpointTreeNode
{
	...
	private function getIdEndpointTreeNode(): EndpointTreeNode
	{
		if (is_null($this->idEndpointTreeNode)) {
			$this->idEndpointTreeNode = new \Api\Config\Objects\EngagementProgram\Gen\Endpoint\EngagementProgramObjectIdEndpointTreeNode($this->objectDefinitionCatalog);
		}
	...
	private function getQueryEndpointDefinitionProvider(): ObjectQueryEndpointDefinitionProvider
	{
		if (is_null($this->queryEndpointDefinitionProvider)) {
			$this->queryEndpointDefinitionProvider = new \Api\Config\Objects\EngagementProgram\Gen\Endpoint\EngagementProgramQueryEndpointDefinitionProvider(
				$this->objectDefinitionCatalog,
				'EngagementProgram',
				'EngagementProgramQueryResultCollectionRepresentation',
				\Api\Gen\Representations\EngagementProgramQueryResultCollectionRepresentation::class,
true
			);
		}
