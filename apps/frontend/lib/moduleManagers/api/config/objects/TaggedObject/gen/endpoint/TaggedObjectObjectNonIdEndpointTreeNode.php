<?php
namespace Api\Config\Objects\TaggedObject\Gen\Endpoint;
 ...
 */
class TaggedObjectObjectNonIdEndpointTreeNode implements EndpointTreeNode
{
	...
	private function getIdEndpointTreeNode(): EndpointTreeNode
	{
		if (is_null($this->idEndpointTreeNode)) {
			$this->idEndpointTreeNode = new \Api\Config\Objects\TaggedObject\Gen\Endpoint\TaggedObjectObjectIdEndpointTreeNode($this->objectDefinitionCatalog);
		}
