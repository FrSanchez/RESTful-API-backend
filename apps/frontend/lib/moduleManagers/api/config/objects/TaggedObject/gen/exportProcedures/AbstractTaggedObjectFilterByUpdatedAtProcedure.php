 ...
 */
abstract class AbstractTaggedObjectFilterByUpdatedAtProcedure implements \Api\Config\Objects\TaggedObject\Gen\ExportProcedures\TaggedObjectFilterByUpdatedAtProcedureInterface
{
	/** @var int $accountId */
	...
	protected final function validate(array $arguments): void
	{
		$this->validateWithArgs(
			$arguments[self::ARG_TARGET_OBJECT_TYPE] ?? null,
	...
	public final function generateDoctrineQuery(QueryContext $queryContext, array $selectedFields): Doctrine_Query
	{
		return $this->generateDoctrineQueryWithArgs(
			$queryContext,
			$selectedFields,
			$this->arguments[self::ARG_TARGET_OBJECT_TYPE] ?? null,
