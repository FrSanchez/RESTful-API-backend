<?php
namespace Api\Config\Objects\TrackerDomain\Gen\Endpoint;
 ...
 */
class TrackerDomainObjectNonIdEndpointTreeNode implements EndpointTreeNode
{
	...
	private function getIdEndpointTreeNode(): EndpointTreeNode
	{
		if (is_null($this->idEndpointTreeNode)) {
			$this->idEndpointTreeNode = new \Api\Config\Objects\TrackerDomain\Gen\Endpoint\TrackerDomainObjectIdEndpointTreeNode($this->objectDefinitionCatalog);
		}
	...
	private function getQueryEndpointDefinitionProvider(): ObjectQueryEndpointDefinitionProvider
	{
		if (is_null($this->queryEndpointDefinitionProvider)) {
			$this->queryEndpointDefinitionProvider = new \Api\Config\Objects\TrackerDomain\Gen\Endpoint\TrackerDomainQueryEndpointDefinitionProvider(
				$this->objectDefinitionCatalog,
				'TrackerDomain',
				'TrackerDomainQueryResultCollectionRepresentation',
				\Api\Gen\Representations\TrackerDomainQueryResultCollectionRepresentation::class,
true
			);
		}
